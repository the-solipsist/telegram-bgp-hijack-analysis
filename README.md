...
Under Section 69A of the IT Act, MEIT directs domestic internet service providers (ISPs) to block access to specific online resources. As documented in research by [Karan Saini](https://cis-india.org/internet-governance/blog/how-india-censors-the-web) and a paper by [Kushagra Singh, Gurshabad Grover, and Varun Bansal](https://arxiv.org/abs/1912.08590), standard blocking procedures in India typically involve DNS sinkholing (such as the DNS-based blocks tracked at [dnsblocks.in](https://dnsblocks.in/)), SNI (Server Name Indication) filtering, or IP blocking to prevent domestic subscribers from accessing the platform.
